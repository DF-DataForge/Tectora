...
| [`tectora_roof_stock`](tectora_roof_stock/) | Bridge to Inventory: the material list of a roof project becomes an outgoing transfer, only for what is not on one yet. Installs itself with Inventory. |
